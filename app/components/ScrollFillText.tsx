...
import logo from '@/assets/metal_cursor.png';
    ...
    <div className={styles.wrapper} >
      ...
      >
        <p className="bg-gradient-to-r from-foreground to-gray-600 bg-clip-text text-transparent">
          Welcome to CryptoWiki — Where Knowledge Meets the Blockchain⚡
        </p>
        <span className={styles.icon}><img src={logo} alt="image" /></span>
      </motion.div>
